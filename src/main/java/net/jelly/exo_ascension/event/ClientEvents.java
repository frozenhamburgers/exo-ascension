package net.jelly.exo_ascension.event;
            ...
            try {
                event.registerShader(
                        new ShaderInstance(
                                ...
                                new ResourceLocation(ExoAscensionMod.MODID, "red_hour"), // matches JSON file
                ...
                event.registerShader(
                        new ShaderInstance(
                                Minecraft.getInstance().getResourceManager(),
                                new ResourceLocation(ExoAscensionMod.MODID, "meteors"), // matches JSON file
                                DefaultVertexFormat.BLIT_SCREEN
                        ),

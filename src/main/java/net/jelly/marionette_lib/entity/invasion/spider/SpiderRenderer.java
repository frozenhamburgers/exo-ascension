...
public class SpiderRenderer extends MobRenderer<SpiderEntity, SpiderModel> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(MarionetteMod.MODID, "textures/entity/spider.png");
    public static final ModelLayerLocation SPIDER_LAYER = new ModelLayerLocation(
            new ResourceLocation(MarionetteMod.MODID, "spider_layer"), "main");

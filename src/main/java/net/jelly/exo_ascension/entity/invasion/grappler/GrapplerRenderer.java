...
import net.jelly.exo_ascension.render.GrapplerEyeLayer;
...
public class GrapplerRenderer extends MobRenderer<GrapplerEntity, GrapplerModel> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(ExoAscensionMod.MODID, "textures/entity/grappler.png");
    public static final ModelLayerLocation GRAPPLER_LAYER = new ModelLayerLocation(
            new ResourceLocation(ExoAscensionMod.MODID, "grappler_layer"), "main");
    ...
    public GrapplerRenderer(EntityRendererProvider.Context pContext) {
        ...
        this.addLayer(new GrapplerEyeLayer<>(this));
    }

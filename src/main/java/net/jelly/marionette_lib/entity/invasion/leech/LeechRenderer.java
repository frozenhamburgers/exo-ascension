...
import net.jelly.marionette_lib.render.LeechEyeLayer;
...
public class LeechRenderer extends MobRenderer<LeechEntity, LeechModel> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(MarionetteMod.MODID, "textures/entity/leech.png");

...
public class GrapplerEyeLayer<T extends LivingEntity, M extends EntityModel<T>> extends RenderLayer<T, M> {
    private static final ResourceLocation EYE_TEXTURE = new ResourceLocation(ExoAscensionMod.MODID, "textures/entity/grapplerE.png");
    private static final RenderType CHARGED_EYES = RenderType.eyes(EYE_TEXTURE);


    public GrapplerEyeLayer(RenderLayerParent<T, M> parent) {
        super(parent);
    }

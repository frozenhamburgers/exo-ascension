package net.jelly.exo_ascension.item;
...
public class ModItems { // holds all items in mod
    ...
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, ExoAscensionMod.MODID);

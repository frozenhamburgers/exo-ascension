...
public class DroneEyeLayer<T extends LivingEntity, M extends EntityModel<T>> extends RenderLayer<T, M> {
    private static final ResourceLocation EYE_TEXTURE = new ResourceLocation(ExoAscensionMod.MODID, "textures/entity/droneE.png");
    private static final RenderType CHARGED_EYES = RenderType.eyes(EYE_TEXTURE);


    public DroneEyeLayer(RenderLayerParent<T, M> parent) {
        super(parent);
    }
